...
import {CommissionctColumn} from '../../../Constant/SuperAdminDashboard/CommissionData'
import Button from 'react-bootstrap/Button';
import ButtonGroup from 'react-bootstrap/ButtonGroup';
import axiosInstance from '../../../config/axios/AxiosConfiguration';

function ProductCommission({productId}) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const commissionResponse = await axiosInstance.get(`userapp/all/commission/details/per/product/admin/dash/${productId}`, {
                  headers: {
                      'Authorization': `Bearer ${token}`
                  }
              });
    ...
    return (
      <>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <p>Here is a historical list of Commissions based on the product {}. </p>
          ...
          <div className='user-dashboard-commission-component-header-container'>
            ...
            <div>
              ...
              <Button variant="light" onClick={() => setSelectedTab('all')} active={selectedTab === 'all'}>All</Button>
                <Button variant="light" onClick={() => setSelectedTab('pending')} active={selectedTab === 'pending'}>Pending</Button>
