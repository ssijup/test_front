...
function TransactionHistoryForParticularProduct({productId}) {
  ...
  useEffect(() => {
    axiosInstance.get(`product/user/overall/per/product/analytics/${productId}`, {
      headers: {
...
export default TransactionHistoryForParticularProduct
